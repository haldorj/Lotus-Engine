...
namespace Lotus
{
    ...
    void Device::CreateInstance()
    {
        ...
        // This is optional, for developer convenience
        ...
        if (enableValidationLayers)
        {
            // Specify which global validation layers to enable
    ...
    {
        // Create list withj size of extenstionCount to hold extensions
        uint32_t extensionCount;
        vkEnumerateDeviceExtensionProperties(device, nullptr, &extensionCount, nullptr);

        // Populate list with extensions
        ...
        // Check if required extensions are in list
